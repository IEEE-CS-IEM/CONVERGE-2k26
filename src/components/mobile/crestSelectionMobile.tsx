...
const CrestSelectionMobile = () => {
  ...
  return (
    <div
      className="w-[100vw] h-[100vh] bg-gradient-to-l 
    from-[#6b0100] to-[#000000] flex items-center justify-center"
    >
      <div className="flex flex-col w-[90%] h-[90%] rounded-[2rem]">
        <div className="w-full flex items-center justify-center p-2 mb-4">
          <motion.h1
            className="text-[1rem] font-formula1 
        ...
        <div
          className="w-full flex flex-grow items-center justify-center
        rounded-[2rem] p-2"
        >
          <div className="w-full h-full grid grid-cols-1 gap-6">
            {crestDetails.map((team) => (
              ...
              >
                ...
                <motion.div
                  className="absolute w-full bottom-[-4rem] z-50"
...
export default CrestSelectionMobile;
